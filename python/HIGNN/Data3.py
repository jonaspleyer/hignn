...
from HIGNN.num_nodes import maybe_num_nodes
...
class Data3(object):
    ...
    def __init__(self, x=None, edge_index=None, edge_index1=None, edge_indexs=None, edge_attr=None, edge_attr1=None,
                 edge_attrs=None, y=None, edge_index_one=None, edge_attr_one=None,
        ...
        self.edge_attr_one = edge_attr_one
    ...
    def debug(self):
        ...
        if self.edge_index1 is not None and self.edge_attr1 is not None:
            if self.edge_index1.size(1) != self.edge_attr1.size(0):
                raise RuntimeError(
                    ('Edge indices of 3body and edge attributes of 3body hold a differing '
                     'number of edges, found {} and {}').format(
                        self.edge_index1.size(), self.edge_attr1.size()))

        if self.edge_indexs is not None and self.edge_attrs is not None:
            if self.edge_indexs.size(1) != self.edge_attrs.size(0):
                raise RuntimeError(
                    ('Edge self indices and edge attributes hold a differing '
                     'number of edges, found {} and {}').format(
                        self.edge_indexs.size(), self.edge_attrs.size()))

        if self.edge_index_one is not None and self.edge_attrs is not None:
            if self.edge_index_one.size(1) != self.edge_attr_one.size(0):
                raise RuntimeError(
                    ('Edge self indices and edge attributes hold a differing '
                     'number of edges, found {} and {}').format(
                        self.edge_index_one.size(), self.edge_attr_one.size()))
